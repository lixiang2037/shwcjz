...
<script src="/javascript/passport.js" type="text/javascript"></script>
	...
	<div class="l_main">
		<div class="main_cont clear">
			...
			<div class="left">
				<ul class="tab">
					<li class="default"><a href="<?php echo U("/user/m_register");?>">手机注册</a></li>
					<li class="current"><a href="<?php echo U("/user/e_register");?>">邮箱注册</a></li>
				</ul>
				<div class="contain">
				<form action="" method="post" id="myform" >
					<ul class="reg_list clear">
						<!--邮箱-->
						<li>
							<span class="w_1">邮箱</span>
							<div class="w_2">
								<input type="text" id="user_name_email" name="user_name"  />
							</div>
						...
						<li>
							...
							<div class="w_2">
								...
								<span id="get_verify_button">
									<a href="javascript:void(0)" onclick="getVerifyByEmail();" class="btn">获取邮箱验证码</a>
								</span>
							</div>
					...
					<div class="loginbtn but">
          			<input type="button" onclick="checkForm(1);" value="立即注册" class="btn"/>
          			</div>
          			</form>
				</div>
				<!--注册左边部分结束-->
