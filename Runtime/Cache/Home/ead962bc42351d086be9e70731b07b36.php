		...
		<div class="l_main">
			...
			<!--左侧栏结束-->
					...
					<div class="right">
						...
						<!--标题结束-->
						<!-- <form  action="<?php echo U('/member/edit_address');?>" method="post" onsubmit="return checkeditForm();"> -->
						<form  action="<?php echo U('/member/edit_address');?>" method="post" onsubmit="return checkForm();">
								<ul class="wrap clear">
									<li>
									...
									<li>
										...
										<div class="w_2">
											<input type="text" id="phone" name="phone" value="<?php echo ($info['phone']); ?>" class="txt"/>
										</div>
									...
									<li>
										...
										<div class="w_2">
											<input type="text" id="tel1" name="tel1" value="<?php echo ($info['tel1']); ?>" class="ti">
											<i>—</i>
											<input type="text" id="tel2" name="tel2" value="<?php echo ($info['tel2']); ?>" class="ti">
											<i>—</i>
											<input type="text" id="tel3" name="tel3" value="<?php echo ($info['tel3']); ?>" class="ti"> 
										</div>
								...
								<input type="hidden" name="address_id" value="<?php echo ($info['address_id']); ?>" />
