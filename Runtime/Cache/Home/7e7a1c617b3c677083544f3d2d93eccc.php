		...
		<div class="l_main">
			...
			<!--左侧栏结束-->
					...
					<div class="right">
						...
						<form  method="post" action="<?php echo U('member/up_password');?>" onsubmit="return checkPwForm();" >
							<ul class="wrap clear">
								<li>
									<span class="w_1">原始密码</span>
									<div class="w_2">
										<input id="password" type="password" name="password" class="txt"/>
									</div>
									<div class="tip clear" id="tip_password"></div>
								</li>
								<li>
									<span class="w_1">新密码</span>
									<div class="w_2">
										<input id="password1" type="password" name="password1" class="txt"/>
									</div>
									<div class="tip clear" id="tip_password1"></div>
								</li>
								<li>
									<span class="w_1">确认新密码</span>
									<div class="w_2">
										<input id="password2" type="password" name="password2" class="txt"/>
									</div>
									<div class="tip clear" id="tip_password2"></div>
								</li>
							</ul>
							<div class="button_mld btn_person clear">
								<input type="submit" value="保存" class="tj"/>
							</div>
						</form>
