...
<!--商品列表banner开始-->
	...
	<div class="l_main">
		<div class="main_cnt">
			...
			<!--标题结束-->
			<ul class="round clear">
			
				<?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li>
					<div class="package_main_img">
						<a href="<?php echo U('/order/view_goods', array('goods_id'=>$info['goods_id']));?>"><img src="<?php echo ($info['goods_img']); ?>" width="200" height="200"/></a>
					</div>
					<div class="package_main_txt">
						<h4><?php echo ($info['goods_name']); ?></h4>
						<p>价格：<?php echo ($info['goods_price']); ?>元</p>
						<a href="<?php echo U('/order/view_goods', array('goods_id'=>$info['goods_id']));?>" class="buy_immediately">立即抢购</a>
						<p class="product_introduction"><?php echo ($info['goods_desc']); ?></p>
					</div>
