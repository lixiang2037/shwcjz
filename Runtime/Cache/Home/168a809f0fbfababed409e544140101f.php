			...
			<!--左侧栏结束-->
					...
					<div class="right">
						...
						<ul class="tab">
							...
							<li class="active"><i><img src="/images/www/icon_phone_hover.png"/></i>验证邮箱</li>
							<li><i><img src="/images/www/icon_over.png"/></i>完成</li>
						</ul>
						<!--验证步骤结束-->
						<form  id="bind_email_form"  method="post" action="<?php echo U('member/bind_email2');?>" onsubmit="return checkBindEmailForm();" >
							<ul class="wrap clear">
								<li>
									<span class="w_1">绑定邮箱</span>
									<div class="w_2">
										<input type="text" id="bind_email"  name="bind_email" value="<?php echo ($bind_email); ?>" class="txt"/>
									</div>
								</li>
								<li>
									<span class="w_1">邮箱验证码</span>
									<div class="w_2">
										<input type="text" name="verify" id="verify" class="txt"/>
										
										<span id="get_verify_button">
											<input type="button" onclick="getVerifyByEmail();" value="获取邮箱验证码" class="btn" >
										</span>
