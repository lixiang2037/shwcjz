				...
				<div class="left">
					...
					<div class="middle">
						<div class="m_c">
							<ul>
								...
								<li class="current"><a href="<?php echo U('/service/sample');?>">采样视频</a></li>
					...
					<div class="right">
						...
						<div class="title">
							...
							<div class="bt">
								<p>采样视频</p>
								<span>ample video</span>
							</div>
							<p class="text">您现在所在的位置 | <a href="<?php echo U('/');?>">首页</a> | <a href="<?php echo U('/service/index');?>">客户服务</a> | <a href="" class="current">采样视频</a></p>
						</div>
						<!--标题结束-->
						<div class="infor">
							采样视频
