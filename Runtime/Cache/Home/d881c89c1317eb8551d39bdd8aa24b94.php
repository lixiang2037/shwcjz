				...
				<div class="content">
					<div class="fram">
						...
						<div class="title">
							...
							<div class="bt">
								<p>选择支付方式</p>
								<span>elect payment method</span>
							</div>
							<p class="text">您现在所在的位置 | <a href="<?php echo U('/');?>">首页</a> |<a href="<?php echo U('/order/gene');?>">我的检索</a> |<a href="" class="current">选择支付方式</a></p>
						</div>
						<!--标题结束-->
						<div class="way">
							<ul>
								<li><input type="radio" class="radio"/></li>
								<li><h1>支付平台</h1></li>
								<li><span>请选择您开通的支付平台进行支付</span></li>	
							</ul>
							<div class="zf clear">
								<a class="current"><input type="radio"/><img src="/images/www/zf_01.jpg"/></a>
								<a><input type="radio"/><img src="/images/www/zf_02.jpg"/></a>
								<a><input type="radio"/><img src="/images/www/zf_03.jpg"/></a>
								<a><input type="radio"/><img src="/images/www/zf_04.jpg"/></a>
							</div>				
						</div>
						<div class="next_btn">
							<a href="<?php echo U('/order/pay_confirmed', array('order_id'=>$order_id));?>">下一步</a>
						</div>
					</div>		
				</div>
			</div>
